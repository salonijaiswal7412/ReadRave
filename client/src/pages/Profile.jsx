...
function Profile() {
    ...
    // Fetch book titles helper function
        ...
        <div>
            <div className='pt-14 px-4 sm:px-6 md:px-8 lg:px-10 max-w-screen min-h-screen bg-white'>
                ...
                <div className="main w-full max-w-6xl mx-auto">
                    ...
                    <div className="flex flex-col lg:flex-row gap-4 lg:gap-0">
                            ...
                            <div className="p-dets flex-1 pr-0 sm:pr-6 mb-4 sm:mb-0">
                                ...
                                {showEdit && (
                                    <div className="fixed inset-0 flex items-center justify-center p-4 z-50 bg-black bg-opacity-50">
                                        <div className="bg-white p-4 sm:p-6 rounded-lg w-full max-w-md shadow-2xl">
                                            <EditProfile
                                                userData={user}
                        ...
                        <div className="shelf w-full lg:w-2/6 mx-0 lg:mx-4 p-4 shadow-[0_0_2rem] shadow-gray-500 h-auto lg:h-60 rounded-xl mb-4 lg:mb-0">
                            ...
                            <div className="flex justify-center">
                                <Link to="/my-shelf" className="text-[#d91c7d] hover:text-pink-700 hover:underline text-md font-semibold tracking-wide">
                                    View Full Shelf
                                </Link>
                            </div>
                        </div>
                    ...
                    {/* Reviews Section */}
                    <div className="reviews-section bg-pink-50 rounded-xl shadow-[0_0_1rem] shadow-gray-300 p-3 sm:p-4 mb-4">
